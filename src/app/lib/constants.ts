...
// Tag colors are semantic, not one-hue-per-tag. Three categories:
// - neutral (default): services/interests — the tag text is enough
// - attention (amber): medical concerns needing follow-up
// - highlight (blue): special status tags
const NEUTRAL = { bg: "bg-gray-50",  text: "text-gray-700",  border: "border-gray-200" };
const ATTENTION = { bg: "bg-amber-50", text: "text-amber-800", border: "border-amber-200" };
const HIGHLIGHT = { bg: "bg-blue-50",  text: "text-blue-700",  border: "border-blue-200" };

export const INTEREST_TAG_COLORS: Record<string, { bg: string; text: string; border: string }> = {
  "Blanqueamiento":         NEUTRAL,
  "Ortodoncia":             NEUTRAL,
  "Implantes":              NEUTRAL,
  "Carillas":               NEUTRAL,
  "Prótesis":               NEUTRAL,
  "Endodoncia":             NEUTRAL,
  "Limpieza profunda":      NEUTRAL,
  "Corona dental":          NEUTRAL,
  "Cirugía oral":           NEUTRAL,
  "Periodoncia":            NEUTRAL,
  "Bruxismo":               NEUTRAL,
  "Sensibilidad dental":    ATTENTION,
  "Enfermedad periodontal": ATTENTION,
  "Caries múltiples":       ATTENTION,
  "Seguimiento pendiente":  ATTENTION,
  "Paciente VIP":           HIGHLIGHT,
  "Reactivar":              HIGHLIGHT,
  "Referido":               HIGHLIGHT,
};

const DEFAULT_TAG_COLOR = NEUTRAL;
